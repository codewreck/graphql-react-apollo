...
var Deploy = /** @class */ (function (_super) {
    ...
    Deploy.prototype.deploy = function (stageName, serviceName, cluster, completeClusterName, force, dryRun, projectNew, workspace) {
        return __awaiter(this, void 0, void 0, function () {
            var localNote, before, b, verb, migrationResult, done, revision, migration, hooks, _i, hooks_1, hook, splittedHook, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.deploying = true;
                    ...
                    case 11:
                        ...
                        _a.label = 12;
                    case 12:
                        if (!(_i < hooks_1.length)) return [3 /*break*/, 15];
                        hook = hooks_1[_i];
                        splittedHook = hook.split(' ');
                        this.out.action.start("Running " + chalk_1.default.cyan(hook));
                        return [4 /*yield*/, spawn_1.spawn(splittedHook[0], splittedHook.slice(1))];
                    case 13:
                        result = _a.sent();
                        this.out.action.stop();
                        this.out.log(result);
