...
var Playground = /** @class */ (function (_super) {
    ...
    Playground.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var web, envFile, serviceName, stage, workspace, cluster, graphqlBin, args, localPlaygroundPath, endpoint, envPath, url;
                ...
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        if (fs.pathExistsSync(localPlaygroundPath) && !web) {
                            ...
                            url = "graphql-playground://?cwd=" + this.config.cwd + "&envPath=" + envPath + "&endpoint=" + endpoint;
                            opn(url, { wait: false });
                            debug(url);
                            debug(process.env);
                        }
